        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl font-bold text-yellow-600 mb-2">Share Your Feedback</h2>
              ...
              <form onSubmit={handleSubmit}>
                ...
                {/* Sample Reviews */}
                <div className="mb-8">
                  <h3 className="text-lg font-medium text-gray-700 mb-4">Recent Feedback</h3>
                  <div className="space-y-4">
                    <div className="flex items-start p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <input 
                        type="checkbox" 
                        className="mt-1 mr-3 h-5 w-5 text-yellow-600 rounded focus:ring-yellow-500" 
                        checked={false} 
                        readOnly 
                      />
                      <div>
                        <p className="font-medium text-gray-800">Mark</p>
                        <p className="text-gray-600 mt-1">The wedding planning was flawless. Everything exceeded our expectations!</p>
                      </div>
                    </div>
                    <div className="flex items-start p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <input 
                      ...
                      />
                      <div>
                        <p className="font-medium text-gray-800">Amandi</p>
                        <p className="text-gray-600 mt-1">Our corporate event was a huge success thanks to Festivo's team.</p>
                      </div>
                    </div>
                  </div>
                </div>
